...
const EditModal = ({ openModal, prompt, placeholder = 'type something', ideaFunc, onCancel, setTitle, title }) => {
    ...
    return (
        <Modal overlayClassName='overlay' isOpen={openModal} onRequestClose={onCancel} className='mini-modal flex flex-col gap-5 items-center w-96 h-50 bg-white'>
            <div className='flex flex-col gap-7 w-full'>
                <Input label={prompt} className={"input2"} wrapper={"wrapper2"} placeholder={placeholder}
