...
const ChatBox = ({ handleCloseModal }) => {
  // modal flex flex-col w-8/12 h-5/6 rounded-t-3xl rounded-b-none bg-white
  return (
    <>
      <div className='flex w-full h-14 items-center justify-between px-4 bg-[#1ED690] rounded-t-3xl rounded-b-none'>
        ...
        <FontAwesomeIcon icon={faXmark} className="text-[#2b2b2b] w-14 h-6 cursor-pointer hover:text-[#F3F5F8]" onClick={handleCloseModal}/>
      </div>
      <div className='chat-area flex flex-col flex-1 w-full bg-white'>
      </div>
