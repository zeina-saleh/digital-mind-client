...
const LoginForm = ({ onToggle }) => {
  ...
  return (
    <div className='flex flex-col items-start gap-5 w-80'>
      ...
      <Input label={'Email'} onChange={(email) => setCredentials({ ...credentials, email })} />
      <Input label={'Password'} onChange={(password) => setCredentials({ ...credentials, password })} type='password' />
