    ...
    return (
        <aside id='sidebar'>
            ...
            <ul className='flex flex-col sidebar-list ml-10 gap-2 mt-16'>
                ...
                {/* <Link className='text-[#F3F5F8]' to="/admin/collections"><li className='sidebar-list-item rounded-l-full'>

                    <FontAwesomeIcon icon={faSwatchbook} className='icon text-[#F3F5F8] cursor-pointer' /> Collections

                </li></Link>
                <Link className='text-[#F3F5F8]' to="/admin/files"><li className='sidebar-list-item rounded-l-full'>
